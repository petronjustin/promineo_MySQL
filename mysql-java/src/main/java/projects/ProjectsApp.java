...
public class ProjectsApp {
	...
	private void updateProjectDetails() {
		...
		BigDecimal actualHours = getDecimalInput("Enter actual hours [" + curProject.getEstimatedHours() + "]");
	...
	private void selectProject() {
		...
		curProject = null; // Unselect the current project
		
		curProject = projectService.fetchProjectById(projectId); // Throws exception if an invalid project id is entered,.
	}
	...
	private boolean exitMenu() {
		System.out.println("Exiting menu, dawg.");
		return true;
	}
